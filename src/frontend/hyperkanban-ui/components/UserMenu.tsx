  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 border border-gray-300 hover:bg-gray-200 transition focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        <svg
